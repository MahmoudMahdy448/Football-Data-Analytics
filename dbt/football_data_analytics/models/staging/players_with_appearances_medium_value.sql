-- models/staging/players_with_appearances_medium_value.sql
-- models/players_with_appearances_high_value.sql
SELECT 
    p.name,
    p.is_retired,
    p.current_club_id,
...
WHERE 
    p.market_value_in_eur >= 1000000.0 AND p.market_value_in_eur < 15000000.0